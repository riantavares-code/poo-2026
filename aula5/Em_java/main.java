...
public class main{
    public static void main(String[] args){
        ...
        if(g != null && c != null && mvalido != null){//se nenhum personagem for nulo comeca a batalha
            g.pegar(ig);
            mvalido.pegar(im);
            ...
            while (c.getVida() > 0){  //testa se o chefe esta morto
                
                for (Personagem heroi : Grupo){
                    if (c.getVida() <= 0) {//interrompe o ataque se o chefe morreu
                        break; 
                    }
                    heroi.ficha();
                    ...
                    if(c.getVida() < 0 ){ //se a vida do chefe for negativa transforma em 0
                         c.setVida(0);
                    }
                    ...
                    System.err.println("\nVerificacao de mago");
                    for (Personagem heroi : Grupo){
                        if (heroi instanceof Mago){ // olha se tem magos
